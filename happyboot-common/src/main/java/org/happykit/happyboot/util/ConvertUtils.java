...
public class ConvertUtils {
    ...
    //多字段排序 TODO 需要修改前端
    public static String doMultiFieldsOrder(Map<String, String[]> parameterMap) {
        ...
        if (ConvertUtils.isNotEmpty(column) && ConvertUtils.isNotEmpty(order)) {
            ...
            if (order.toUpperCase().indexOf(ORDER_TYPE_ASC) >= 0) {
                sb.append(String.format(" order by %s asc", ConvertUtils.camelToUnderline(column)));
            } else {
                sb.append(String.format(" order by %s desc", ConvertUtils.camelToUnderline(column)));
            }
        }
        return sb.toString();
    }
    ...
    public static String underlineToCamel(String param) {
        ...
        while (mc.find()) {
            ...
            String.valueOf(Character.toLowerCase(sb.charAt(position)));
