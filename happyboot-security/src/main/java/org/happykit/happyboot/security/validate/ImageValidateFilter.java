package org.happykit.happyboot.security.validate;//package com.litong.ltitframework.boot.core.security.validate;
...
public class ImageValidateFilter extends OncePerRequestFilter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ImageValidateFilter.class);
    @Autowired
